...
{
  if(ReactDOM.findDOMNode(this.inner.current).getBoundingClientRect().height != b.tamanho)
    this.resize();
}
  ...
  render() {
    ...
    <div ref={this.inner} style={{position:'absolute', top:0, left:0, zIndex:'-1', overflow:'visible', fontSize:"initial"}} >
        {this.props.children}
    </div>
    </div>
      )
