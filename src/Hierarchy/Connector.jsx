...
export class Connector extends React.Component {
  constructor(props) {
    super(props);
    this.state = {}
    this.props.start.reposition = this.resize;
    this.props.end.reposition = this.resize;
  }
  componentDidUpdate(){
    console.log("upd");
  }
  ...
  render() {
    ...
    return (
            ...
            <path  d={'M '+ startPoint.x + ' ' + startPoint.y  + linePoint.reduce((a,b) =>{return a + ' L'+ b.x + ' ' + b.y },'') } style={{stroke:color,strokeWidth:2, fill: 'none'}}  />
    );
  }
}
